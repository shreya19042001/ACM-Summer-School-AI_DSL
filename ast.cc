...
void Plus_Expr_Ast::gencode(ofstream& genf)
{ 
if (get_type_info()->is_tensor_type()){
get_left_child()->gencode(genf);
    genf<< ".add(";
    get_right_child()->gencode(genf);
    genf <<")";
...
void Minus_Expr_Ast::gencode(ofstream& genf)
{
if (get_type_info()->is_tensor_type()){
get_left_child()->gencode(genf);
    genf<< ".sub(";
...
void Mult_Expr_Ast::gencode(ofstream& genf)
{
if (get_type_info()->is_tensor_type()){
get_left_child()->gencode(genf);
    genf<< ".mul(";
...
void MatMul_Expr_Ast::gencode(ofstream& genf)
{
    get_left_child()->gencode(genf);
    genf<< ".mm(";
    get_right_child()->gencode(genf);
...
Conv_Expr_Ast::Conv_Expr_Ast(Ast * l, Ast * r, Type_Info *type_info)
{	
	assert (l);
	assert (r);
	set_left_child(l);
...
void Conv_Expr_Ast::print_ast(int sc, ostream & file_buffer, bool top_level)
{
        print_spaces_on_new_line (sc, file_buffer);
	file_buffer << "Arith: Conv";
...
void Conv_Expr_Ast::gencode(ofstream& genf)
{
    get_left_child()->gencode(genf);
    genf<< ".conv(";
    get_right_child()->gencode(genf);
...
void Div_Expr_Ast::gencode(ofstream& genf)
{
if (get_type_info()->is_tensor_type()){
get_left_child()->gencode(genf);
    genf<< ".div(";
...
void UMinus_Expr_Ast::gencode(ofstream& genf)
{
    genf << " - ";
    get_opd()->gencode(genf);
}
//////////////////////////////////////////////////////////////////////
